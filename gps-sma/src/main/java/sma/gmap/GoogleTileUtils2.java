...
public class GoogleTileUtils2 {
   ...
   */
   ...
   public static String getSatelliteRef(double lat, double lng, int zoom) {
      ...
      StringBuffer satString = new StringBuffer(30);
      satString.append("t");
   ...
   * @return
   */
   public static Point satelliteRefToTileXY(String satelliteRef) {
      // must start with "t"
   ...
   public static void main(String[] args) {
      ...
      System.out.println("expect 0,0,180,85 (V1= \t" +  GoogleTileUtils.getLatLong(1, 0, 16));
